    ...
    <section class="banner1 clearfix">
      ...
      <div class="container text-center">
        ...
        <div class="clearfix">
          ...
          <div class="col-lg-4"><hr class="hr-cus12"></div>
          <div class="col-lg-4"></div>
        </div>
        ...
        <div class="clearfix">
          <div class="row">
            <div class="row row-position">
              <div class="col-lg-12"><hr class="hr-cus12"></div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12"  style="margin-top: -10px"><hr class="hr-cus12"></div>
            </div>
          </div>
        </div>
    ...
    <section class="clearfix about-us" style="background-color: #990000">
      ...
      <div class="container text-center">
        ...
        <div class="clearfix">
          ...
          <div class="col-sm-4 col-xs-4"><hr class="hr-cus12 hr-cus121"></div>
          <div class="col-sm-4 col-xs-4"></div>
        </div>
        <div class="clearfix">
